...
tasks.jar {
    manifest {
        ...
        attributes(
            ...
            "Implementation-Title" to "Lumora", // Leaf - Rebrand // Lumora - Rebrand
            "Implementation-Version" to implementationVersion,
            "Implementation-Vendor" to date,
            "Specification-Title" to "Lumora", // Leaf - Rebrand // Lumora - Rebrand
            "Specification-Version" to project.version,
            "Specification-Vendor" to "Winds Studio", // Leaf - Rebrand
            "Brand-Id" to "kyssta-exe:lumora", // Leaf - Rebrand // Lumora - Rebrand
            "Brand-Name" to "Lumora", // Leaf - Rebrand // Lumora - Rebrand
