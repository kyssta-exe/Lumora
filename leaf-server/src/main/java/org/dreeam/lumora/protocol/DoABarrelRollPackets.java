...
public class DoABarrelRollPackets {
    ...
    private static <T extends LumoraCustomPayload> LumoraCustomPayload.Type<T> createType(String path) {
        return new LumoraCustomPayload.Type<>(Identifier.fromNamespaceAndPath(DoABarrelRollProtocol.NAMESPACE, path));
    }

    public record ConfigResponseC2SPacket(int protocolVersion, boolean success) implements LumoraCustomPayload {
    ...
    ) implements LumoraCustomPayload {
    ...
    public record ConfigUpdateAckS2CPacket(int protocolVersion, boolean success) implements LumoraCustomPayload {
    ...
    public record ConfigUpdateC2SPacket(int protocolVersion, ModConfigServer config) implements LumoraCustomPayload {
    ...
    public record RollSyncC2SPacket(boolean rolling, float roll) implements LumoraCustomPayload {
    ...
    public record RollSyncS2CPacket(int entityId, boolean rolling, float roll) implements LumoraCustomPayload {
