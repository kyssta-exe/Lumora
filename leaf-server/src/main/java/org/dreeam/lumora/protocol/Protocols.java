...
public final class Protocols {
    ...
    public record TypeAndCodec<B extends FriendlyByteBuf, T extends LumoraCustomPayload>(LumoraCustomPayload.Type<T> type,
                                                                                       StreamCodec<B, T> codec) {
    }

    public static <B extends FriendlyByteBuf> void write(B byteBuf, LumoraCustomPayload payload) {
    ...
    @Contract("_ -> new")
    public static ClientboundCustomPayloadPacket createPacket(LumoraCustomPayload payload) {
        return new ClientboundCustomPayloadPacket(payload);
    }

    private static <B extends FriendlyByteBuf> void encode(B byteBuf, LumoraCustomPayload payload, Protocol protocol) {
    ...
    private static @Nullable LumoraCustomPayload decode(Protocol protocol, DiscardedPayload payload) {
