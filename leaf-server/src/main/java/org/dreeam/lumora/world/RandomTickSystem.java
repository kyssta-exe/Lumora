package org.dreeam.lumora.world;
...
import org.dreeam.lumora.config.modules.gameplay.IceAndSnowChance;
...
public final class RandomTickSystem {
    ...
    public void tick(ServerLevel world) {
        ...
        if (org.dreeam.lumora.config.modules.opt.MutableBlockPos.enabled) {
