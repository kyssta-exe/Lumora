...
import org.dreeam.lumora.config.modules.async.SparklyPaperParallelWorldTicking;
...
public final class MSPTCommand extends PermissionedLumoraSubcommand {
    ...
    public boolean execute(final CommandSender sender, final String subCommand, final String[] args) {
        ...
        if (!SparklyPaperParallelWorldTicking.enabled) {
            sender.sendMessage(Component.text()
                ...
                .build());
            sender.sendMessage(Component.text()
                .content("Please enable it in your Lumora configuration to use this command.")
                .color(GRAY)
                .build());
            return true;
        }
