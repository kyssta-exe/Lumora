...
public final class VersionCommand extends PermissionedLumoraSubcommand {
    ...
    public boolean execute(final CommandSender sender, final String subCommand, final String[] args) {
        ...
        if (ver != null) {
            ver.execute(sender, LumoraCommand.COMMAND_LABEL, me.titaniumtown.ArrayConstants.emptyStringArray); // Gale - JettPack - reduce array allocations
        }
