package org.dreeam.lumora.config.modules.network;

import org.dreeam.lumora.config.ConfigModules;
import org.dreeam.lumora.config.EnumConfigCategory;
import org.dreeam.lumora.protocol.DoABarrelRollPackets;
import org.dreeam.lumora.protocol.DoABarrelRollProtocol;
...
public class ProtocolSupport extends ConfigModules {
    ...
    public static int xaeroMapServerID = ThreadLocalRandom.current().nextInt(); // Lumora - Faster Random
