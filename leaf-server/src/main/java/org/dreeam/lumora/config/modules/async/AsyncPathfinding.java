...
import org.dreeam.lumora.async.path.PathfindTaskRejectPolicy;
...
public class AsyncPathfinding extends ConfigModules {
    ...
    public void onLoaded() {
        ...
        if (enabled) {
            LumoraConfig.LOGGER.info("Using {} threads for Async Pathfinding", asyncPathfindingMaxThreads);
            org.dreeam.lumora.async.path.AsyncPathProcessor.init();
        }
    }
}
